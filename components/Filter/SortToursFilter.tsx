      ...
      <div className="row align-items-center">
        <div className="col-xl-4 col-md-4 mb-10 text-lg-start text-center">
          <div className="box-view-type">
            {/* <Link className="display-type display-grid active" href="/turlar">
              <svg
                width={22}
                height={22}
                viewBox="0 0 22 22"
            ...
            <span className="text-sm-bold neutral-500 number-found">
              {startItemIndex} - {endItemIndex} / {sortedTours.length} tur
              bulundu
            </span>
          </div>
        </div>
        <div className="col-xl-8 col-md-8 mb-10 text-lg-end text-center">
          <div className="box-item-sort">
            ...
            <div className="item-sort border-1">
              <span className="text-xs-medium neutral-500 mr-5">Sırala:</span>
              ...
              <select value={sortCriteria} onChange={handleSortChange}>
                ...
                <option value="price">Fiyatı</option>
